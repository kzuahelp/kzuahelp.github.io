...
<i18n>
  ru:
    description: "Наша благотворительная ярмарка в онлайн-формате. Вся прибыль с продажи представленных здесь товаров будет отправлена в качестве гуманитарной помощи народу Украины."
  kz:
