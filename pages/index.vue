...
ru:
  ...
  become-volunteer-description:
    ...
    <li>Изготовление продукции для благотворительных ярмарок и нашего <a href=\"https://www.instagram.com/help_ukraine_market/\">магазина</a>.</li>
    </ul>
...
kz:
  ...
  become-volunteer-description:
    ...
    <li>Ұйымдық көмек.</li>
    <li>Қайырымдылық жәрмеңкелеріне және біздің <a href=\"https://www.instagram.com/help_ukraine_market/\">дүкенге</a> арналған өнімдерді шығару.</li>
    </ul>
...
ua:
  ...
  become-volunteer-description:
    ...
    <li>Виготовлення продукції для благодійних ярмарків та нашого <a href=\"https://www.instagram.com/help_ukraine_market/\">магазину</a>.</li>
    </ul>
...
en:
  ...
  become-volunteer-description:
    ...
    <li>Making products for charity fairs and our <a href=\"https://www.instagram.com/help_ukraine_market/\">store</a>.</li>
    </ul>
