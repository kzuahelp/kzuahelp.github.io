...
ru-RU:
  ...
  point-place-working-time-diapason: "с 10:00 ч до 19:00 ч ежедневно"
...
kk-KZ:
  ...
  our-mission-description:
    "<p>Біздің гуманитарлық көмек жинау қозғалысы 25-ші ақпанда «Ел болашағы» азаматтық бастамасын жариялаумен басталды.</p>
    ...
    <p>13-ші наурыздан бастап «Ел болашағы» қозғалысынан зейнеткерлікке шықты және Украинаның гуманитарлық қолдау штабындағы еріктілердің өздері, қарапайым қазақстандықтар қазір Украинаға гуманитарлық көмек ұйымдастыруда.</p>
    <p>5-ші наурыздағы есептеу бойынша жанашыр қазақстандықтардан 150 миллион теңгеден астам қаржы түсті.</p>
    <p>Әлеуметтік желілердегі басты кеңсеміз:</p>"
  how-can-you-help: "Сіз қалай көмектесе аласыз?"
  medicines: "Медициналық көмек мен дәрі-дәрмектер"
  food: "Азық-түлік"
  for-childs: "Балаларға арналған"
  field-medicine: "Әскери далалық медицина"
  ...
  point-place-working-time-diapason: "күн сайын 10:00-ден 19:00-ге дейін"
  ...
  become-volunteer-description:
    ...
    <ul>
    <li>Көмекті жинауға қол ұшын беру - қабылдау, орау, жүктеу, тиеу.</li>
    <li>Онлайн көмектесу - кеңес беру, SMM, дизайн, аударма, ақпаратты іздеу және т.б..</li>
    <li>Қаражат жинаудағы ұйымдық әрекеттер.</li>
    </ul>
    <p>Сіздің қабілеттеріңіз бен дағдыларыңыз бізге пайдалы болуы мүмкін.</p>"
  volunteer-form: "Ерікті формасын толтырыңыз"
  our-friends: "Олар бізге көмектеседі"
  gratitude: "Алғыс"
  appeal-description:
    "<p>Украинаның Қазақстан Республикасындағы елшісінің әйелінің Халықаралық әйелдер күніне орай Қазақстан әйелдеріне арнаған үндеуі:</p>"
  appeal:
    "Құрметті қазақстандық әйелдер, әпкелер мен сіңлілер, аналар бүгінгі мерекемізде мен сіздерге еңбектеріңіз үшін рахмет айтқым келеді.Кез-келген ауа-райда туған еліме көмектесіп, ерікті болып еңбек етіп жатқандарыңыз үшін алғыс айтқым келеді. Сіз кейде үйіңіздегі соңғы затты көтеріп, дәрі-дәрмекті әкелгеніңіз үшін және бұл біздің әйелдер мен балаларымызға көмектеседі деп үміттенгеніңіз үшін. Сіздің жаялықтарыңыз, жөргектеріңіз және балалар тағамы үшін, олар қазірдің өзінде Украинаға көп мөлшерде жеткізілді және күн сайын жеткізілуде. Мен осындай керемет қолдау үшін, біз алатын осындай жанашырлық толқыны үшін алғыс айтамын."
  oksana-vrublevskaya: "Оксана Врублевская" 
  arman-shuraev: "Арман Шураев"
  arman-shuraev-position: "Қоғам қайраткері және кәсіпкер"
  arman-shuraev-action: "Ол «Ел болашағы» бастамасын қолдап, гуманитарлық көмекті сұрыптап, тиеген еріктілерге палау ұйымдастырып, еріктілердің тамағына 1 миллион теңге бөлді."
...
ru-UA:
  ...
  point-place-working-time-diapason: "з 10:00 до 19:00 щоденно"
...
en-US:
  ...
  point-place-working-time-diapason: "from 10:00 to 19:00 every day"
