...
kk-KZ:
  ...
  field-medicine: "Далалық медицина"
  point-place: "Гуманитарлық көмекті қабылдау пункті Украинаның Қазақстан Республикасындағы Елшілігінде мына мекенжай бойынша орналасқан:"
  point-place-working-time: "Гуманитарлық көмекті алу уақыты:"
...
ru-UA:
  ...
  our-mission-description:
    ...
    <p>Єл болашати запустив рух, організував волонтерів, закликав казахстанців допомагати мирному населенню України, яке прямо зараз потребує екстреної гуманітарної допомоги в умовах війни.</p>
    <p>З 13 березня Ел Болашағ відійшов від руху, і організацією гуманітарної допомоги в Україну тепер займаються самі волонтери, звичайні казахстанці зі Штабу гуманітарної підтримки України.</p>
    <p>На 5 березня надійшло понад 150 млн тенге від небайдужих казахстанців.</p>
  ...
  point-place-working-time-diapason: "з 9:00 год до 20:00 год щоденно"
  card-to-bank: "Переведіть кошти з картки до Нац. Банк України:"
  transfer-to-embasy: "Переказайте кошти на рахунок Посольства з реквізитів:"
  ...
  become-volunteer-description:
    ...
    <ul>
    <li>Фізична участь у зборі допомоги - прийом, упаковка, маркування, навантаження.</li>
  ...
  gratitude: "Подяка"
  appeal-description:
    <p>Звернення дружини Посла України в Республіці Казахстан у міжнародний жіночий день до жінок Казахстану:</p>
  appeal:
    Дорогі казахстанські сестри, сьогодні у наше свято хочу сказати вам рахмет за вашу працю, за те, що ви працюєте волонтерами, допомагаючи моїй рідній країні за будь-якої погоди. За те, що ви везете іноді останнє зі свого будинку, звільняючи аптечку, сподіваючись, що це допоможе нашим жінкам та дітям. За ваші памперси, пелюшки та дитяче харчування, яке у величезних кількостях вже поїхало в Україну та продовжує їхати щодня. Я дякую вам за таку неймовірну підтримку, за таку хвилю співпереживання та співчуття, яку ми отримуємо.
